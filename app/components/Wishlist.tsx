    ...
    <section className="relative py-24 px-6 bg-gradient-to-b from-gray-50 to-gray-100 text-gray-800">
      <div className="max-w-5xl mx-auto text-center relative">
        ...
        <div className="relative max-h-[600px] overflow-y-auto pr-2 scroll-smooth scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-transparent">
          ...
          {/* Cards */}
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 pb-12 pt-2">
            <AnimatePresence>
              {guests.map((g, i) => (
                <motion.div
                  key={g.id}
                  ...
                  className="
                    group relative bg-white border border-gray-200 rounded-2xl
                    p-6 text-left shadow-sm hover:shadow-md
                    transition-all duration-300 overflow-hidden
                  "
                >
                  {/* Hover overlay */}
                  <div className="absolute inset-0 bg-gradient-to-br from-gray-100/0 to-gray-200/40 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
